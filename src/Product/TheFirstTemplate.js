...
export default function TheFirstTemplate() {
  const imageUrl =
    "https://shopeefood.vn/app/assets/img/main-banner.jpg?45bff8c9ec408a5ba51f9fdef662324e";
  const imageIcon =
    "https://shopeefood.vn/app/assets/img/bg-icon.png?2404d5c158d1d09104c34443b2fd5f44";
  ...
  const showShop = async () => {
    const result = await axios.get(
      "http://localhost:8080/api/shops/findByIdCategory/1"
    );
    setShop(result.data);
  };
  ...
  const handleSearch = useCallback(async () => {
    ...
    const result = await axios.get(
      `http://localhost:8080/api/shops/findShopByName?name=${searchQuery}`
    );
        ...
        <div className="container-hiha">
          <div className="now-search">
            <div>
              ...
              <div className="local">
                có 45944 địa điểm ở Hà Nội từ 00:00 - 23:59
              </div>
            </div>
                  ...
                  {searchResults.map((item) => (
                    <div className="item-restaurantcc" key={item.id}>
                      <Link
                        ...
                        className="item-contentcc"
                      >
                        <div className="img-restaurantcc">
                          <img
                            className="img-smallcc"
                        ...
                        <div className="info-restaurantcc">
                          <div className="info-basic-ress">
                            <h4 className="name-ressc" title={item.name}>
                              {item.name} - {item.idCategory.name}
                            </h4>
            ...
            <div className="category-list-filter">
              <a className="haha" href="#">
                <Link to="/listProduct" className="category-item">
                  All
                </Link>
              </a>
              <a className="haha" href="#">
            ...
            <div className="user-get-local">
              <div className="row align-items-center no-gutters pointer">
                <div className="col-auto">
                  ...
                  <FontAwesomeIcon
                    className=" ml-2 font12"
                    icon={faArrowRightLong}
                  />
                </div>
                <div className="col pl-2 pr-2 txt-elipsis">
                  QL32, Đức Giang, Hoài Đức, Hoài Đức, Hà Nội
                </div>
                <div className="col-auto">
                  <span className="pl-2 pr-2 link" data-toggle="modal">
                    <FontAwesomeIcon
                      className="txt-gray-7"
                      icon={faAngleRight}
                    />
                  </span>
                </div>
                  ...
                  <div className="item-restaurants" key={item.id}>
                    ...
                    >
                      ...
                      <div className="info-restaurants">
                        <div className="info-basic-ress">
                          <h4 className="name-ress" title={item.name}>
                            {item.name} - {item.idCategory.name}
                          </h4>
                          <div className="address-res" title={item.address}>
                            {item.address}
                          </div>
                        </div>
